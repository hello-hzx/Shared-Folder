...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            <%--    // 判断用户名是否可用--%>
            <%--    $.getJSON(${requestScope.basePath}+"userServlet","action=ajaxExistsUsername?username=" + value,function (data) {--%>
...
<%--                        <%=request.getAttribute("msg") == null ? "" : request.getAttribute("msg") %>--%>
                ...
                <div class="form">
                    <form action="userServlet" method="post">
                        ...
                        <img id="code_img" src="kaptcha.jpg" style="float: right; margin-right: 40px; width: 100px">
                        <br/>
                        <br/>
